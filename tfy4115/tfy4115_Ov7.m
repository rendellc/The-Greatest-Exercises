...
theta0grad = 15;  % Startvinkel (startamplitude) for pendelen i GRADER
...
thetalin(2)=theta0;
error(1)=theta(1) - thetalin(1);
error(2)=theta(2) - thetalin(2);
...
for n=2:(length(t)-1)
   ...
   error(n+1) = theta(n+1) - thetalin(n+1);
end
