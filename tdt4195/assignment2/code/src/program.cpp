...
void runProgram(GLFWwindow* window)
{
    ...
    //glfwSetWindowTitle(window, "r:0.5, g: 0.0, b:-0.5, draw order: b->g->r");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4x4 cameraMatrix = glm::translate(glm::vec3(-camera.x, -camera.y, -camera.z)) * glm::yawPitchRoll(0.f, -camera.pitch, 0.f) * glm::yawPitchRoll(-camera.yaw, 0.f, 0.f);
